...
function loadSVG(session) {
    ...
    d3.csv("data/s-"+session+"-all-t.csv", function(error, data) {  
      ...
      function toggleParties(options) {
        ...
        var dist = 0;
        var distLess = 0;
        $(".table-one").append("<tr> <th> First class </th> </tr>");
        $(".table-two").append("<tr> <th> Second class </th> </tr>");
        $(".table-three").append("<tr> <th> Third class </th> </tr>");
        circles.filter(function(d) {
